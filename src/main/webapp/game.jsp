...
<c:if test="${question == null}">
    ...
    <c:if test="${wrongAnswer == null}">
        <h1>Благодаря вашим действиям, карантин сработал. <br>Угроза локализована. Вас благодарят за оперативность и профессионализм.</h1>
    </c:if>
    <button onclick="window.location='/restart'" class="button button1">Начать сначала</button>
</c:if>
</body>
</html>
